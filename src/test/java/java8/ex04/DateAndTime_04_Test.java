...
public class DateAndTime_04_Test {
	...
	public void test_localDateTime_of() {
		...
		// 01/01/2018
		LocalDateTime result = LocalDateTime.of(2018, 01, 01, 12, 0);
	...
	public void test_localDateTime_parse() {
		...
		LocalDateTime result = LocalDateTime.parse("2009-02-03 09:30", DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm"));
