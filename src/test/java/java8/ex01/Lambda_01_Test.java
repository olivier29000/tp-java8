...
public class Lambda_01_Test {
	...
	public void test_filter_by_age() throws Exception {
		...
		PersonPredicate predicate = p -> p.getAge() >= 18 ? true : false;
	...
	public void test_filter_by_firstname() throws Exception {
		...
		// "first_10"
		PersonPredicate predicate = p -> p.getFirstname().equals("first_10") ? true : false;
		List<Person> result = filter(personList, predicate);
	...
	public void test_filter_by_password() throws Exception {
		...
		PersonPredicate predicate = p -> p.getAge() > 49
